$(function(){
    ...
    $(document).on('click','.btn_modalEdit',function(){
        var modalURI = '/invite/link_modal/';
        ...
        if($(this).hasClass('btn_modalOpen')){ // 最初のページ
            ...
            modalURI += 'invite_link.html';
        }else if($(this).hasClass('btn_top_link')){
            modalURI += 'top_link.html';

        }else if($(this).hasClass('confirm_link')){
            modalURI += 'lawyer_link.html';
        }else if($(this).hasClass('post-detail')){
            modalURI += 'detail_link.html';
        }else if($(this).hasClass('complete_link')){ // インポート
            modalURI += 'complete_link.html'
        ...
        }else if($(this).hasClass('btn_return_link')){
            modalURI += 'top_link.html'
    ...
    }).on('click','.modal_back_link',function(){ //キャンセル、BACKを押した時
    ...
    function modal(modalURI,modalEdit){
        if(modalURI != '/invite/link_modal/' && modalURI.match(/.html/)){
            $.ajax({
                type: "GET",
                url: modalURI,
                dataType:"html",
