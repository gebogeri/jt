...
(function (e) {
            ...
            slimScroll: function (g) {
                ...
                this.each(function () {
                    ...
                    function m(d, e, g) {
                        ...
                        e && (f = parseInt(c.css("top")) + d * parseInt(a.wheelStep) / 100 * c.outerHeight(), f = Math.min(Math.max(f, 0), h), f = 0 < d
                            ? Math.ceil(f)
                            : Math.floor(f), c.css({
                            top: f + "px"
                        }));
                    ...
                    function w() {
                        ...
                        clearTimeout(B);
                        l       ==~~ l
                            ? (k = a.allowPageScroll, C != l && b.trigger("slimscroll", 0 ==~~ l
                                ? "top"
                                : "bottom"))
                            : k = !1;
                        C       = l;
                    ...
                    if (b.parent().hasClass(a.wrapperClass)) {
                        ...
                        n        = e("<div></div>")
                            ...
                            .css({overflow: "hidden", position: "relative", width: a.width});
                        b.css({maxHeight:"580px",overflow: "hidden", width: a.width});
                        var h = e("<div></div>")
    ...
    e
        .fn
        .extend({slimscroll: e.fn.slimScroll})
})(jQuery);
$(function(){
